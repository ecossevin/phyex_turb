...
!#ENDIF
!
WRITE (0, *) "PDP1(1,1) = ", PDP(1,1)
WRITE (0, *) "KGRADIENTSLEO = ", KGRADIENTSLEO
WRITE (0, *) "KGRADIENTSGOG = ", KGRADIENTSGOG
WRITE (0, *) "KRR = ", KRR
WRITE (0, *) "KRRL = ", KRRL
WRITE (0, *) "KRRI = ", KRRI
WRITE (0, *) "KSV_LGEND = ", KSV_LGEND
WRITE (0, *) "KSV_LGBEG = ", KSV_LGBEG
WRITE (0, *) "KSV = ", KSV
WRITE (0, *) "KSV_LIMA_NH = ", KSV_LIMA_NH
WRITE (0, *) "KSV_LIMA_NG = ", KSV_LIMA_NG
WRITE (0, *) "KSV_LIMA_NS = ", KSV_LIMA_NS
WRITE (0, *) "KSV_LIMA_NR = ", KSV_LIMA_NR
WRITE (0, *) "HLBCY(2) = ", HLBCY(2)
WRITE (0, *) "HLBCX(2) = ", HLBCX(2)
WRITE (0, *) "KSPLIT = ", KSPLIT
WRITE (0, *) "OCLOUDMODIFLM = ", OCLOUDMODIFLM
WRITE (0, *) "KHALO = ", KHALO
WRITE (0, *) "OCOMPUTE_SRC = ", OCOMPUTE_SRC
WRITE (0, *) "OOCEAN = ", OOCEAN
WRITE (0, *) "ODEEPOC = ", ODEEPOC
WRITE (0, *) "OFLYER = ", OFLYER
WRITE (0, *) "OFLAT = ", OFLAT
WRITE (0, *) "OCOUPLES = ", OCOUPLES
WRITE (0, *) "OBLOWSNOW = ", OBLOWSNOW
WRITE (0, *) "ODIAG_IN_RUN = ", ODIAG_IN_RUN
WRITE (0, *) "OIBM = ", OIBM
WRITE (0, *) "PDP0(1,1) = ", PDP(1,1)
IKT=D%NKT
IKTB=D%NKTB
IKTE=D%NKTE
IKB=D%NKB
